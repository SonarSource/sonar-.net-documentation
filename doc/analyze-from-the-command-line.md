...
1. **Run the MSBuild.SonarQube.Runner.exe begin phase**
	...
	**>>NOTE >>** If any of the arguments contain spaces then that argument needs to be surrounded by double-quotes e.g. **/name:”My Project Name”**.
	...
	See [Configuring the SonarQube Scanner for MSBuild](appendix-2.md) below for more information on passing additional settings.
...
2. **Launch your normal project build**
	...
	**>>NOTE >>** make sure to run *MSBuild.SonarQube.Runner.exe* in a "MSBuild console", or a "VS Developer Command Prompt" otherwise you will not be able to access MSBuild command and you may get an error similar to "'msbuild' is not recognized as an internal or external command,operable program or batch file."
